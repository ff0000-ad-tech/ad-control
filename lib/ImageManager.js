...
class ImageManager {
	...
	static _pendingImages = []
	static _pendingCanvasImages = []
	static _pendingLoaders = []
	static _nextLoadCallback = []
	static _imageManagerLoader
	static _dict = {}
	static _isLoading = false
	static _loaderCount = 0
	static _onComplete = function() {}
	static _onFail = function() {}
	...
	*/
	static addToLoad = function(file, arg) {
	...
	*/
	static addLoader = function(loader) {
		ImageManager._pendingLoaders.push(loader)
	}
	...
	*/
	static available = function(imageId, internal) {
		var exists = ImageManager._dict[imageId] != undefined
	...
	*/
	...
	static load = function(callback, onFail) {
		const I = ImageManager
	...
	static addFbaImages = function(target) {
		if (target) ImageManager._addToDictionary(target.getAllContentRaw())
	}

	/* ------------------------------------------------------------------------------------------------------------- */
	// PRIVATE METHODS
	static _addToDictionary = function(content) {
		const I = ImageManager
